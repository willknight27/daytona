...
from .views import agregar_vehiculo, eliminar_trabajos, home,contacto, listar_trabajos, registro,trabajos,agregar_trabajo,modificar_trabajos
...
urlpatterns = [
    ...
    path('agregar-vehiculo/',agregar_vehiculo,name="agregar-vehiculo"),
